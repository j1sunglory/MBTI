export const questions = [
  {
    number: '01',
    question: '곧 회사 워크샵! 큰 상금이 걸린 게임 팀 대표를 뽑는다는데?',
    choices: [
      { text: '난 절대 안 나감ㅎ...<br>(그래도 재밌겠는데..?)', value: 'i' },
      { text: '오!상금 대박 <br> 내가 나갈게요~', value: 'e' }
    ]
  },
  {
    number: '02',
    ...
    choices: [
      ...
      { text: '내일 출발인데요, <br>아직 짐 안싼 사람 여깄습니다만', value: 'n' }
    ]
  },
  {
    number: '03',
    ...
    choices: [
      ...
      { text: '아 이직하나?<br>어디로 가냐고 물어봐야지.', value: 't' }
    ]
  },
  {
    number: '04',
